  ...
  <section class="events">
    ...
    <div class="event-list" id="eventList">
      <div class="event-card" data-category="tech">
        <img src="images/event1.jpg" alt="Tech Event">
      ...
      <div class="event-card" data-category="music">
        <img src="images/event2.jpg" alt="Music Event">
      ...
      <div class="event-card" data-category="sports">
        <img src="images/event3.jpg" alt="Sports Event">
      ...
      <div class="event-card" data-category="education">
        <img src="images/event4.jpg" alt="Education Event">
        <h3>Career Growth Workshop</h3>
